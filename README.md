# cg-labs —— 计算机图形学实验与课程项目

> 上海大学 2026-2027 秋季学期《计算机图形学》08306027 · 4 人小组
...
- [ ] 实验一：中点/Bresenham 直线（任意斜率）、圆弧中点算法、线型线宽 —— 已验收
- [ ] 实验二：扫描线多边形填充、扫描线种子填充、线段裁剪 —— 已验收
- [ ] 实验三：平移/放缩/旋转，多选图形，重心及任意参考点 —— 已验收
- [ ] 实验四：n 阶 Bezier（de Casteljau）+ 鼠标控制调整 —— 已验收
- [ ] 实验五（选做）：模型导入 + Lambert/Phong 渲染 —— 已验收
